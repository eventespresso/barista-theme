	...
	if ( 'espresso_events' == get_post_type() ) :
			?>
				<span class="fl-post-date">
					<a href="<?php the_permalink(); ?>" rel="bookmark"><time class="entry-date published" datetime="<?php echo espresso_event_date( '', '', get_the_ID() ); ?>" itemprop="datepublished"><?php echo espresso_event_date( '', '', get_the_ID() ); ?></time></a>
				</span>
	<?php 
	else :
